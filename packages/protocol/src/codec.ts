 ...
 *
 * The generated types describe the shapes but vanish at runtime, and frames
 * arriving off a socket are untrusted input. These guards are the boundary
 * where an unknown frame becomes a typed one, or gets dropped.
 */
